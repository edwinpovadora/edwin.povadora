        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a id="service_page"  href="<?= base_url();?>index.php/Service" class="nav-item nav-link">Services</a>
                    <a id="package_page"  href="<?= base_url();?>index.php/Package" class="nav-item nav-link">Packages</a>
                    <div class="nav-item dropdown">
                        <a href="#" id="pages_page" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu m-0">
                            <a href="destination.html" class="dropdown-item">Destination</a>
                            <a href="<?= base_url();?>index.php/Booking" class="dropdown-item">Booking</a>
                            <a href="<?= base_url();?>index.php/Team" class="dropdown-item">Travel Guides</a>
                            <a href="<?= base_url();?>index.php/Testimonial" class="dropdown-item">Testimonial</a>
                            <a href="<?= base_url();?>index.php/404" class="dropdown-item">404 Page</a>
                        </div>
                    </div>
